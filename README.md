...
3. Run through IntelliJ or if you have docker on your machine run ```docker build -t recipe-db .``` and then ```docker run --rm -p 8080:8080 --env-file {PATH_TO_YOUR_ENV_FILE} recipe-db```
